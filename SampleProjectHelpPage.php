...
<html>
	...
	<body>
		<div id = "container">
			...
			<div id = "topHalf">
				<div class = "standardPosition">
					<h1>Welcome To The Help Page</h1> </br></br>
					<p>If you would like a tutorial of how the app works, <a href = "#">click here.<a/> If you </br>
					would like to file a complaint or give general feedback, <a href = "SampleProjectFeedbackPage.php">click here.<a/></p>
				</div>
			</div>
